...
- `api/v1/services/account_user_access_service.py`: tenant-spezifische Permission-/Feature-Resolution fuer `/users/me`
...
## Authorization-Referenz

- Permission-Matrix: `docs/backend/accounts/authorization-permission-matrix.md`
